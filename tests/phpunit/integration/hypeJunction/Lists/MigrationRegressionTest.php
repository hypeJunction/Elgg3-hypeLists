...
/**
 * Auto-generated migration regression guard for plugin "hypelists".
 *
...
final class MigrationRegressionTest extends TestCase
{
    ...
    /**
     * Blank out // # and block/doc comments while preserving line numbers, so a
     * removed-symbol *named in a comment* (e.g. a migration `// TODO: fn() removed`
     * note) is not mistaken for a live call. Newlines inside comments are kept so
    ...
    public function testNoRemovedSymbols(): void
    {
        ...
        foreach (self::files('', 'php') as $file) {
            ...
            $scan = self::stripComments((string) file_get_contents($file));
            foreach (explode("\n", $scan) as $n => $line) {
